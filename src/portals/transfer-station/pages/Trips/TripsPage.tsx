...
export default function TripsPage() {
  ...
  const [weight, setWeight] = useState('25') // الحمولة القياسية افتراضاً (00131)
    ...
    <div className="space-y-5" data-testid="trips-page">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <label className="flex flex-col gap-1 text-xs font-medium text-slate-600">
            الوزن (طن) <span className="text-red-500">*</span> <span className="font-normal text-slate-400">(القياسي 25 طن)</span>
            <input
              type="number"
              min={0.1}
              step={0.1}
