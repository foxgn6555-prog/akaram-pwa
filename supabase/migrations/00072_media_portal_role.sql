-- ═══════════════════════════════════════════════════════════════
-- 00072 · بوابة الإعلام: دور media_officer
-- لا توجد جداول أعمال في هذه الجولة؛ لا تضيف migration أي سياسة RLS أو وصول للبيانات.
-- ═══════════════════════════════════════════════════════════════
...
begin
  ...
  order by array_position(array[
    ...
    'complaints_officer', 'media_officer', 'department_manager', 'employee'
  ], role)
  limit 1;
...
-- أحدث توقيع من 00051/00055: أربعة معاملات مع متصرّف صريح لخدمة admin-users.
...
-- تأكيد صلاحيات الغلافين الموجودين وتقييد نسخة الخدمة.
